...
export const EXPENSE_SUBCATEGORIES: Record<ExpenseCategory, { value: string; label: string; limitType?: 'meal' | 'welfare' | 'commute' | 'vehicle_maintenance'; requireDocs: string[]; notes?: string; entryType: 'auto_recurring' | 'manual_recurring' | 'manual_person' | 'manual_site' }[]> = {
  site_residence: [
    {
      value: 'lodging_rent',
      label: '숙식비 (임대비)',
